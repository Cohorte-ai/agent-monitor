# Contributing to theaios-agent-monitor
...
git clone https://github.com/Cohorte-ai/agent-monitor.git
cd agent-monitor
...
- Use [GitHub Issues](https://github.com/Cohorte-ai/agent-monitor/issues) to report bugs or request features.
